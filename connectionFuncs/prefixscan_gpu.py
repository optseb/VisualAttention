...
# Wrapping scan2_recursive_min.py into a function:
def prefixscan_gpu(d_weight_ar, d_scanf_ar, arraysz, arrayszplus, threadsperblock):
    import math
...
# Call the function:
prefixscan_gpu (d_weight_ar, d_scanf_ar, arraysz, arrayszplus, threadsperblock)
