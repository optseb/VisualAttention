    ...
    namespace nn {
        ...
        struct NetConn
        {
            ...
            void commonInit (morph::vVector<T>* _out)
            {
                ...
                // Unlike FeedForwardNet, we size ws based on the output of the connection.
                this->ws.resize (this->out->size());
                // Don't resize each weight, instead may construct with weight maps.
            ...
            // Weights.
            // This is a sorted version of the weights generated by the script.
