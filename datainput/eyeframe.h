...
namespace wdm
{
    ...
    public:
        ...
        void init (const double& backgroundLum) {
            ...
            this->neuralFieldSize = 150;
            this->E2 = 2.5;
            this->fieldOfView = 151; // Originally 151 degrees. -75 to 75. Offset is
            ...
            // Generate/setup the locations of the neuralFieldSize^2 neurons once only.
